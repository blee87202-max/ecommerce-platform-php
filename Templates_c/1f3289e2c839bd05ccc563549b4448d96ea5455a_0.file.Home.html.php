<?php
/* Smarty version 4.3.4, created on 2026-01-19 13:29:55
  from 'C:\wamp64\www\ecommerce_project\Home.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_696e31d3c2fd53_42327082',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1f3289e2c839bd05ccc563549b4448d96ea5455a' => 
    array (
      0 => 'C:\\wamp64\\www\\ecommerce_project\\Home.html',
      1 => 1768744554,
      2 => 'file',
    ),
  ),
  'includes' => 
  array (
    'file:mobile_splash.php' => 1,
  ),
),false)) {
function content_696e31d3c2fd53_42327082 (Smarty_Internal_Template $_smarty_tpl) {
...
<html lang="ar" dir="rtl" class="preload">
  <head>
    ...
    <meta property="og:image" content="admin/assets/images/share.png" />

    <!-- Fonts -->
    <link rel="preconnect" href="https://fonts.googleapis.com" />
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
    <link rel="preload" href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@700;900&family=Cairo:wght@400;600;700;800&display=swap" as="style" />
    <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@700;900&family=Cairo:wght@400;600;700;800&display=swap" rel="stylesheet" media="all" />
    ...
    <?php echo '<script'; ?>
 src="Home.js" defer><?php echo '</script'; ?>
>
 ...
 type="application/ld+json">
      {
        ...
        "potentialAction": {
          "@type": "SearchAction",
          "target": "Home.php?q={search_term_string}",
        ...
        <div class="container">
            <div class="compare-content">
                ...
                <div class="compare-actions">
                    <a href="compare.php" class="btn-compare-view">
        ...
        <div class="container header-container">
            <div class="header-top-row">
                ...
                <div class="header-actions">
                    ...
                    <a href="wishlist.php" class="action-btn wishlist-trigger">
                    ...
                    <div class="user-menu">
                        <?php if ($_smarty_tpl->tpl_vars['logged_in']->value) {?>
                            <div class="user-avatar" id="user-avatar-trigger">
                                <img src="<?php if ($_smarty_tpl->tpl_vars['user']->value['avatar'] && $_smarty_tpl->tpl_vars['user']->value['avatar'] != 'default_avatar.png') {?>admin/assets/images/<?php echo $_smarty_tpl->tpl_vars['user']->value['avatar'];
} else { ?>admin/assets/images/default-avatar.png<?php }?>" 
...
" />
                                <div class="user-dropdown" id="user-dropdown-menu">
                                    ...
                                    <a href="my_orders.php"><i class="fas fa-box"></i> طلباتي</a>
                                    <a href="logout_user.php"><i class="fas fa-sign-out-alt"></i> تسجيل الخروج</a>
                                </div>
                            </div>
                        <?php } else { ?>
                            <a href="login.php" class="action-btn login-btn">
            ...
            <div class="search-wrapper">
                <form id="search-form" action="Home.php" method="GET" class="search-form">
...
" autocomplete="off" />
        ...
        <div class="search-overlay" id="search-overlay">
            ...
            <div class="search-container">
                <form action="Home.php" method="GET" class="search-form-full" id="search-form-full">
      ...
      <!-- Cinematic Hero Section -->
	      <section class="cinematic-hero" id="hero-story">
	        ...
	        <div class="hero-layers">
	            <div class="layer layer-bg" style="background-image: url('admin/assets/images/video-poster.jpg');"></div>
...
')">
	                                    <img src="image.php?src=<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'urlencode' ][ 0 ], array( $_smarty_tpl->tpl_vars['cat']->value['image'] ));?>
&w=300&h=300&q=80" 
...
" 
	                                         ...
	                                         onerror="this.src='admin/assets/images/default-category.jpg'; this.parentElement.classList.remove('skeleton-loading')" />
...
%</span><?php }?>
                                  ...
                                  <img src="image.php?src=<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'urlencode' ][ 0 ], array( $_smarty_tpl->tpl_vars['prod']->value['image'] ));?>
&w=400&h=400&q=90" 
                                       alt="<?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['prod']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
" 
                                       loading="lazy"
                                       onerror="this.src='admin/assets/images/default-product.png'" />
...
" title="عرض سريع">
                              ...
                              <div class="product-info-v2">
                                  <h3 class="product-title-v2">
                                      <a href="product.php?id=<?php echo $_smarty_tpl->tpl_vars['prod']->value['id'];?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                      <?php } else { ?>
                          <div class="no-products">
                              ...
                              <a href="Home.php" class="btn-primary">عرض جميع المنتجات</a>
                          </div>
                      <?php }?>
                  </section>
...
" min="0" max="100000" />
    ...
    <?php if ($_smarty_tpl->tpl_vars['show_mobile_splash']->value) {?>
        <?php $_smarty_tpl->_subTemplateRender('file:mobile_splash.php', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
    <?php }?>
